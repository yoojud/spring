...
public class BoardController {
    ...
    // 게시글 수정화면 => http://127.0.0.1:8081 /board/update.do ?no=1692603694745
    ...
    // 글내용 수정 => http://127.0.0.1:8081 /board/updateaction.do
    ...
    public String boardOne(@RequestParam(name = "no") long no, Model model) {
        ...
        Long next = bRepository.selectBoardNext(no);
        System.out.println(next);

        Long prev = bRepository.selectBoardPrev(no);
